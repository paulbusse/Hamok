...
* [ZIP file](https://github.com/paulbusse/Hamok/archive/refs/tags/v23.2.zip)
* [Compressed tarball(.tgz)](https://github.com/paulbusse/Hamok/archive/refs/tags/v23.2.tar.gz)

You should now have a file `Hamok-v23.2.[zip|tar.gz]`in your current directory. Unpack this archive where you want to install Hamök. I install it in the home directory of my `homeassistant`account.
